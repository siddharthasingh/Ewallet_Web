...
<link rel="shortcut icon" type="image/x-icon" href="retinafreestansard/css/images/favicon.png" />
...
<div id="wrapper">
	...
	<div class="shell">
		...
		<div class="container">
			...
			<div><a href="${pageContext.request.contextPath}/home.jsp"><img src="${pageContext.request.contextPath}/retinafreestansard/css/images/logo_ew.jpg"   ></a>
		...
		<div id="first">
<p><h3>User Already Registered !!!</h3></h3></p>

<h2 align="center"> click here to <a href="login.jsp">login</a></h2>
...
<div id="footer">
				...
				<p class="copy">&copy; Copyright 2016<span>|</span>E-Wallet</p>
				<div class="cl">&nbsp;</div>
			</div>
			<!-- end of footer -->
		</div>
